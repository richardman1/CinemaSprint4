...
namespace IVH7_Cinema.WebUI.Website.HtmlHelpers
{
    public static class CultureHelpers
    {
        ...
        "nl-NL",  // Dutch culture is the DEFAULT
        "en-GB", // English NEUTRAL culture
        "fr-FR"  // French NEUTRAL culture
        };
        ...
        /// <summary>
        /// Returns a valid culture name based on "name" parameter. If "name" is not valid, it returns the default culture "nl-NL"
        /// </summary>
